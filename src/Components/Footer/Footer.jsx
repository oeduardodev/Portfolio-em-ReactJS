...
function Footer (){
    return(
        <footer className={style.Footer} id="contato">
            ...
            <li className={style.ItenContato}><BsGithub className={style.Icone}/> <a target="_blank" href="https://github.com/jovemscript/"> Meu GitHub </a></li>
            </div>
            <div className={style.Dev}>
            <p>Copyright by Eduardo Leite <br/>24 de janeiro de 2023</p>
            </div>
        </footer>
    )
}
